    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" >
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#">                  Bestel <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
...
<main role="main">
  ...
  <footer class="container">
    ...
    <!-- <p><img src="Facebook.png" height="50" width="50"> <img src="instagram.jpg" height="50" width="50"> <img src="twitter-logo.jpg" height="50" width="50"> --><p> <img src="logos.webp" height="100" width="390"></p> -->
  </footer>
</main>
